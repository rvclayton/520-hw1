...
var p = new BFSGridProblem(
  start, goal, [ new Coordinate(1, 0), new Coordinate(0, 1)], 2, 2);

var pathEnd = BFSGridSolver(p, nullGrid);
...
if (true) {
  ...
  p = new BFSGridProblem(start, goal, [ ], 2, 2);
  pathEnd = BFSGridSolver(p, nullGrid);
...
if (true) {
  ...
  p = new BFSGridProblem(start, goal, obstacles, rows, cols);
